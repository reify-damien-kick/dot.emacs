...
(custom-set-variables
 ...
 '(package-selected-packages
   '(lsp-ui flycheck lsp-treemacs graphql-mode dockerfile-mode terraform-mode lsp-python-ms lsp-mode elpy cl-lib yaml-mode groovy-mode tide smartparens paredit company exec-path-from-shell cider projectile scala-mode sbt-mode slime hydra))
